...
- `SYSTEM_ARCHITECTURE.md` — visual state machine flowcharts, rendering pipeline & web architecture diagrams
- `MASTER_LEARNING_CHECKLIST.md` — master download & core concepts learning checklist
